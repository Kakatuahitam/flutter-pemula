...
import 'package:flutter_pemula/screens/aboutscreen_m.dart';
...
class HomeScreenMedium extends StatelessWidget{
  const HomeScreenMedium({Key? key}) : super(key: key);
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: Image.asset('images/icons/pramukauinjkt48px.png', width: 56, height: 56, fit: BoxFit.contain)
              ...
              child: Row(
                ...
                children: [
                      ...
                      InkWell(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) {
                            return const AboutScreenMedium();
                          }));
                        },
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Text('Masuk', style: ThemeText.standardBoldW.copyWith(fontSize: 14)),
                      const SizedBox(width: 16),
                      const CircleAvatar(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text('  (coming soon)', style: ThemeText.standardSoonP.copyWith(fontSize: 14.0)),
                                    ],
                                  ),
                                ),
                              ),
