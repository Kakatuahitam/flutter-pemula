      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Divider(thickness:1 , color: Constant.LS_ECRU_WHITE),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text('Beranda', style: ThemeText.standardNormal_w),
                  Text('Visi Misi', style: ThemeText.standardNormal_w),
                  Text('Pengurus', style: ThemeText.standardNormal_w),
                  Text('Tentang Website', style: ThemeText.standardNormal_w),
                ],
              ),
            ),
            Container(
